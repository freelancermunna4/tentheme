        ...
        <div class="p-5 justify-between items-center bg-white rounded-lg shadow-md border border-[
          ...
          <div class="mb-1 w-full">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center gap-4 justify-between">
              ...
              <div class="w-fit">
                <button data-target="add_pack" class="popup_show button"> Add Pack </button>
              </div>
            </div>
          </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Pack
                        Name </th>
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Award
                        Coins </th>
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Click
                        Price </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100">
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 3 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 0.10 Coin </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 0.5 Coin </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> $0.00 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 20 seconds </td>
                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <a href="./edit-website-pack.php" type="button"
