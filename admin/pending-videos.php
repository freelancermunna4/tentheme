                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Video
                      </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100">
                      ...
                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <a href="./edit-video.php" type="button" class="btn bg-green-600 w-fit text-white">Edit</a>
                        <button data-target="delete_video" type="button"
