                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Game
                        Name
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Game
                        Value
                      </th>

                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5">Prize
                      </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100">
                      ...
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> taka </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 30 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 300 </td>
