      ...
      <div class="x_container space-y-10 py-10">
        <form class="grid grid-cols-2 gap-y-8 gap-x-12">
          <div class="col-span-2">
            <h2 class="text-xl font-semibold text-cyan-800">Add New Lottery</h2>
          </div>
          ...
          <div class="col-span-2 lg:col-span-1 flex flex-col gap-y-1">
            ...
            <input class="input py-2" type="file" id="Select Image" placeholder="Select Image">
          </div>

          <div class="col-span-2 lg:col-span-1 flex flex-col gap-y-1">
            <label for="Video Link">Video Link</label>
            <input class="input" type="text" id="Video Link" placeholder="Video Link">
          </div>
