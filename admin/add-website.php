      ...
      <div class="x_container space-y-10 py-10">
        <form class="grid grid-cols-2 gap-y-8 gap-x-12">
          ...
          <div class="col-span-2 lg:col-span-1 flex flex-col gap-y-1">
            ...
            <input class="input" type="text" id="Website Title" placeholder="Website Title" required>
          </div>

          <div class="col-span-2 lg:col-span-1 flex flex-col gap-y-1">
            <label for="Website Address">Website Address</label>
            <input class="input" type="text" id="Website Address" placeholder="Website Address" required>
          </div>
