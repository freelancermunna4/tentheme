              ...
              <div class="overflow-auto bg-white">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      <th scope="col"
                        class="p-4 text-xs font-medium text-left text-gray-500 uppercase whitespace-nowrap lg:p-5"> Page
                        ID </th>
                      <th scope="col"
                        class="p-4 text-xs font-medium text-left text-gray-500 uppercase whitespace-nowrap lg:p-5"> Page
                        URL </th>
                      ...
                      <th scope="col"
                        ...
                        Reason </th>
                      <th scope="col"
                        class="p-4 text-xs font-medium text-left text-gray-500 uppercase whitespace-nowrap lg:p-5"> Date
                      </th>
                      <th scope="col"
                        class="p-4 text-xs font-medium text-left text-gray-500 uppercase whitespace-nowrap lg:p-5">
                        Actions </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-100">
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 33 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> <a
                          class="text-blue-600" href="https://google.com">https://google.com</a> </td>

                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 12 </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> sagar </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> youtube </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> pending </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> n/a </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 22-12-2022 </td>

                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <button data-target="delete_lottery" type="button"
                          class="popup_show btn bg-red-500 w-fit text-white">Delete</button>
                        <button type="button" class="btn bg-green-600 w-fit text-white">Solve</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
